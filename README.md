...
This assignment was cool and wil be useful to any doing a project involving sensors. I had trouble figuring out the order of things but I had help from others and my teachers. I suggest looking up things on Adafruit for help. There are lots of helpful tips and recources that can help you with the code.
...
Get the stepper motor to move its arm in one direction to turn the limit switch.
...
## Design Goal for Color Coded Crane
